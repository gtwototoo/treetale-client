...
export const notFoundVariants: App.Error[] = [
	...
	},
	{
		...
		img: `${PUBLIC_TREESTORY_CLIENT_URL}/img/compressed/404_house@1024x1024.png`,
		color: [30, 47, 49]
	}
];
